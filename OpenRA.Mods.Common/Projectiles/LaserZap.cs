...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class LaserZapInfo : IProjectileInfo
	{
		...
		{
			var c = UsePlayerColor ? Player.ActorColor(args.SourceActor) : Color;
	...
	public class LaserZap : IProjectile, ISync
	{
		...
		public LaserZap(LaserZapInfo info, ProjectileArgs args, Color color)
		{
			...
			this.info = info;
			this.color = color;
			secondaryColor = info.SecondaryBeamUsePlayerColor ? Player.ActorColor(args.SourceActor) : info.SecondaryBeamColor;
